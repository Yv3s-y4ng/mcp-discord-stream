    ...
    this.server.setRequestHandler(CallToolRequestSchema, async (request) => {
      ...
      try {
        ...
        switch (name) {
          ...
          case "discord_read_messages_stream":
            this.logClientState("before discord_read_messages_stream handler");
            toolResponse = await readMessagesStreamHandler(args, this.toolContext);
            return toolResponse;

          case "discord_read_multiple_channels":
            this.logClientState("before discord_read_multiple_channels handler");
            toolResponse = await readMultipleChannelsHandler(args, this.toolContext);
            return toolResponse;

          case "discord_get_channel_list":
            this.logClientState("before discord_get_channel_list handler");
            toolResponse = await getChannelListHandler(args, this.toolContext);
            return toolResponse;

          case "discord_get_forum_post_stream":
            this.logClientState("before discord_get_forum_post_stream handler");
            toolResponse = await getForumPostStreamHandler(args, this.toolContext);
            return toolResponse;

          case "discord_archive_forum_stream":
            this.logClientState("before discord_archive_forum_stream handler");
            toolResponse = await archiveForumStreamHandler(args, this.toolContext);
            return toolResponse;

          case "discord_archive_multiple_forums":
            this.logClientState("before discord_archive_multiple_forums handler");
            toolResponse = await archiveMultipleForumsHandler(args, this.toolContext);
            return toolResponse;
